...
-->
                         ...
                         <input   class="form-control2 input-sm chat-input" > 
                         
                         <input type="password" name="lpassword" id="lpassword" class="form-control2 input-sm chat-input" placeholder="Mot de passe" ></br>
                        </br>
       ...
       <?php
        ...
        if($result == true){
           ...
           <?php }
            ...
            <div class="sentence" > <?php   echo "portant l'identifiant: ".$_POST['dpseudo']." n'existe pas";  ?> </div>
         <?php }
    }
*/
